...
import Logo from '../../../../public/images/logo_sin_texto.png';
...
export default function AuthSplitLayout({ children, title, description }: PropsWithChildren<AuthLayoutProps>) {
    ...
    return (
        <div className="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0 overflow-y-auto py-6 sm:py-0">
            ...
            <div className="w-full lg:p-8">
                <div className="mx-auto flex w-full flex-col justify-center space-y-4 sm:w-[350px]">
                    <Link href={route('home')} className="relative z-20 flex items-center justify-center lg:hidden">
                        <img src={Logo} className="h-32 sm:h-40 fill-current  " />
                    </Link>
