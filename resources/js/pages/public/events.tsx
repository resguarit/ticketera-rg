            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-200 to-background">
                ...
                <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-4">
                    ...
                    <div className="mb-4 sm:mb-6 lg:mb-8 w-full mt-6">
                        ...
                        {/* Separar ordenador de los filtros */}
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-foreground space-y-3 sm:space-y-0 mb-4">
